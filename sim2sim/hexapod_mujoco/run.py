...
def _arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--duration", type=float, default=20.0, help="Maximum policy rollout duration in seconds.")
...
def main() -> None:
    ...
    with viewer_context as viewer:
        ...
        simulation.run(options=options, metrics=metrics, viewer=viewer)
